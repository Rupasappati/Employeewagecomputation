...
namespace Employeewagecomputation
{
    public class MultipleCompanies
    {
        ...
        public MultipleCompanies(string company, int emp_Wage_Per_Hr, int working_Days_Per_Month, int max_Hrs_Per_Month)
        {
        ...
        public void ComputeEmpWage()
        {
            ...
            Console.WriteLine("Total Days: {0}, Total working hours: {1}", totalWorkingDays, total_Emp_Hrs);
